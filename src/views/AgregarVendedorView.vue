          ...
          <form action="" class="form-horizontal left">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <input type="text" class="form-control" name="rol" id="rol" placeholder="ej. vendedor" v-model="form.role" disabled>
                    </div>
                    <div class="col-xl-4">
                ...
                <div class="row">                    
                    <div class="col-xl-4">
                        ...
                        <input type="date" class="form-control" name="createat" id="createat" placeholder="ej. 2022-05-23" v-model="form.createAt" disabled>
                    </div>
                    <div class="col-xl-4">
                        <label>Email</label> 
    ...
    methods: {
        guardar(){
            ...
            .then(data => {
                ...
                alert(this.Mensaje + ". Vendedor registrado. Por favor, actualizar la página")  
            })
            .catch(err => {
