<template>
  <div>
    ...
    <div class="container izquierda">
        <div class="row">
          <h1>Lista de centros de distribución</h1>
        </div>
        <br>
        <div class="row">
...
export default {
    ...
    methods: {
        editar(id){
            this.$router.push('/editarcentrodistribucionview/' + id)
        },
        agregar(){
            this.$router.push('/agregarcentrodistribucionview')
        },
        buscar(){
            this.$http
            .get("/distributions/" + this.SearchId)
            .then(datos => {
                console.log(datos)
            })
            .catch(err => {
            ...
            this.$router.push('/editarcentrodistribucionview/' + this.SearchId)
        }
    },
    mounted: function(){
        this.$http
