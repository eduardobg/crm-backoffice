    ...
    methods:{
        editar(){
            ...
            .then(data => {
                ...
                alert(this.Mensaje + ". Cliente actualizado. Por favor, actualizar la página")
            })
            .catch(err => {
        ...
        suspender(){
            ...
            .then(data => {
                this.Mensaje = data.statusText
                alert(this.Mensaje + ". Cliente suspendido. Por favor, actualizar la página")
            })
            .catch(err => {
                console.log(err)
            })
        ...
        activar(){                      
            ...
            .then(data => {
                this.Mensaje = data.statusText
                alert(this.Mensaje + ". Cliente activo. Por favor, actualizar la página")
            })
            .catch(err => {
                console.log(err)
            })
